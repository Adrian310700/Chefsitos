...
import com.chefsitos.uamishop.ordenes.service.OrdenRequest;
...
public class OrdenController {
   ...
   */
  @PostMapping
  public ResponseEntity<Orden> crear(@RequestBody OrdenRequest request) {// // Spring transforma automáticamente el JSON en un OrdenRequest usando @RequestBody
